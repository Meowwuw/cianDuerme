...
export default function Login() {
  const { loginGoogle, error } = useAuth()

  return (
    <div className="login">
      <Mascota estado="dormido" size={200} />
      <h1 className="login-titulo">
        <span className="app-title__cian">Cian</span> duerme
      </h1>
      <p className="login-sub">Registro de sueño y tomas, en la palma de la mano.</p>
...
function IconoGoogle() {
  return (
    <svg width="20" height="20" viewBox="0 0 48 48" aria-hidden="true">
      ...
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.2-4.1 5.6l6.2 5.2C39.9 35.9 44 30.5 44 24c0-1.3-.1-2.3-.4-3.5z"
      />
    </svg>
  )
}
